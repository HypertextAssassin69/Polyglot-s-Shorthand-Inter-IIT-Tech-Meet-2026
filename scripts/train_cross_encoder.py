...
from src.polyglot.models.v1_normalization import CrossEncoderRanker
...
PRED_PATH = "C:/Users/hiaar/.gemini/antigravity/brain/2b8c0d59-79d1-442a-98a8-9a8f70fc8e10/scratch/cross_encoder_predictions.jsonl"
MODEL_PATH = "C:/Users/hiaar/.gemini/antigravity/brain/2b8c0d59-79d1-442a-98a8-9a8f70fc8e10/scratch/cross_encoder_model.pt"
...
def sanity_check(model, dl, device):
    ...
    print(f"CrossEncoder Scorer weight diff: {diff:.6f}")
    ...
    assert diff > 0.0, "Parameters did not update!"
            ...
            for i in range(len(preds)):
                ...
                if save_preds:
                    ...
                    predictions.append({
                        ...
                        "cross_encoder_score_pred": logits[i, preds[i]].item(),
                        "cross_encoder_score_gold": logits[i, t_idx].item() if t_idx != -1 else None,
                        "all_scores": logits[i, :len(cands)].tolist()
                    })
...
def train():
    ...
    # 1. Sanity Check
    model = CrossEncoderRanker(vocab_size=vocab_size, char_vocab_size=char_vocab_size).to(device)
